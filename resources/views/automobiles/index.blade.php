        ...
        <div class="box box-primary">
            <div class="box-header">
                <div class="class-md-4">
                    <button type="button" id="btn-new-branch" class="btn btn-secondary"><i class="fas fa-plus" aria-hidden="true"></i> Novo Automóvel</button>
                </div>
                <br>
                <!-- /.box-header -->
                        ...
                        <tbody>
                            @foreach($automobiles as $list)
                                <tr>                                   
                                    ...
                                    <td class="text-center" width="15%">{{$list->chassi_number}}</td>
                                    <th class="text-center" width="15%">{{$list->category_id}}</th>
